...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		foreach($result as $row)
		{
			...
			{
				$status = '<button type="button" name="status_button" class="btn btn-primary btn-sm status_button" data-id="'.$row["doctor_schedule_id"].'" data-status="'.$row["doctor_schedule_status"].'">Activo</button>';
			}
			else
			{
				$status = '<button type="button" name="status_button" class="btn btn-danger btn-sm status_button" data-id="'.$row["doctor_schedule_id"].'" data-status="'.$row["doctor_schedule_status"].'">Inactivo</button>';
			}
	...
	if($_POST["action"] == 'Add')
	{
		...
		$success = '<div class="alert alert-success">Cronograma del Doctor agregado exitosamente!</div>';
	...
	if($_POST["action"] == 'Edit')
	{
		...
		$success = '<div class="alert alert-success">Datos del cronograma del doctor actualizado exitosamente</div>';
	...
	if($_POST["action"] == 'change_status')
	{
		...
		echo '<div class="alert alert-success">Estado del cronograma del doctor actualizado a '.$_POST['next_status'].'</div>';
	}
	...
	if($_POST["action"] == 'delete')
	{
		...
		echo '<div class="alert alert-success">El cronograma del doctor ha sido eliminado</div>';
	}
}
