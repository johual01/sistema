...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Mantenimiento del cronograma del doctor</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-primary">Listado del cronograma del doctor</h6>
                            	</div>
                                ...
                                <table class="table table-bordered" id="doctor_schedule_table" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Día del cronograma</th>
                                            <th>Hora de inicio</th>
                                            <th>Hora de finalización</th>
                                            <th>Tiempo de consulta</th>
                                            <th>Estado</th>
                                            <th>Acción</th>
                                        </tr>
                                    </thead>
    	...
    	<form method="post" id="doctor_schedule_form">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">Agregar cronograma</h4>
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Tiempo de consulta promedio</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fas fa-clock"></i></span>
                            </div>
                            <select name="average_consulting_time" id="average_consulting_time" class="form-control" required>
                                <option value="">Seleccione duración de consulta</option>
                                <?php
                                $count = 0;
                                for($i = 1; $i <= 15; $i++)
                                {
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
	        	...
	        	$('#modal_title').text('Editar datos del cronograma del doctor');
