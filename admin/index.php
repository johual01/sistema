...
<head>
    ...
    <title>Sistema de control de citas de doctores</title>
...
<body class="text-center">
    <main class="form-signin">
         <form method="post" id="login_form">
            <h1 class="h3 mb-3 fw-normal">Sistema de control de citas de doctores</h1>
            <span id="error"></span>
            <div class="form-group">
                <input type="text" name="admin_email_address" id="admin_email_address" class="form-control" required autofocus data-parsley-type="email" data-parsley-trigger="keyup" placeholder="Ingrese dirección de mail..." />
            </div>
            <div class="form-group">
